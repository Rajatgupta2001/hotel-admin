/**
 * AccountStatements Model Interfaces
...
export interface IAccountStatements {
  ...
  weekdaytype?: string;
  rmrent?: number;  // Default: text("'0.000000'"
  ...
  usedquantity?: number;  // Default: text("'0.000000'"
  refid?: string;
  isinclusion?: number;  // Default: 0
  movedtotrans?: number;  // Default: 0
  movedqty?: number;  // Default: text("'0.000000'"
  ...
  modifiededate?: Date;
  modifiedqty?: number;
  usedamount?: number;  // Default: text("'0.000000'"
  movedamount?: number;  // Default: text("'0.000000'"
  forcheckout?: number;  // Default: 0
  promocodedisc?: number;  // Default: text("'0.000000'"
  value1?: number;  // Default: text("'0.000000'"
  value2?: number;  // Default: text("'0.000000'"
  value3?: number;  // Default: text("'0.000000'"
  taxappliedon?: string;
  value5?: string;
