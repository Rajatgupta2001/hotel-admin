...
export class StorageService {
  ...
  seedSampleData(): boolean {
    // Disabled: do not seed any static/sample data
    console.warn('seedSampleData is disabled in this build.');
    return false;
  }
  ...
  private generateSampleHotelData(): AppData {
    // Disabled: return empty/default app data
    return { ...DEFAULT_APP_DATA } as AppData;
  }
