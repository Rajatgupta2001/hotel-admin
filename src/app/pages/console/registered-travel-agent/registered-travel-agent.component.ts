...
@Component({
  selector: 'app-registered-travel-agent',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1 class="mat-headline-4">Registered Travel Agent</h1>
        <p class="mat-body-1 text-on-surface-variant">
          Manage Registered Travel Agent configurations and settings
        </p>
      </div>
...
export class RegisteredTravelAgentComponent {
  ...
  items = computed(() => [] as TravelAgentItem[]);
  ...
  editItem(item: TravelAgentItem): void {
