...
@Component({
  selector: 'app-registered-corporate',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1 class="mat-headline-4">Registered Corporate</h1>
        <p class="mat-body-1 text-on-surface-variant">
          Manage Registered Corporate configurations and settings
        </p>
      </div>
      ...
      <div class="content-cards">
        ...
        <mat-card class="table-card">
          ...
          <mat-card-content class="card-content table-container">
            @if (items().length === 0) {
              <div class="empty-state">
                <mat-icon color="accent">business_center</mat-icon>
                <p class="empty-title">No items configured yet</p>
...
export class RegisteredCorporateComponent {
  ...
  items = computed(() => [] as CorporateItem[]);
