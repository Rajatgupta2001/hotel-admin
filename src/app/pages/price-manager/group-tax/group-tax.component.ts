...
@Component({
  ...
  template: `
    <div class="max-w-7xl mx-auto h-full">
      <div class="mb-4">
        <h1 class="text-xl font-bold text-gray-900 mb-1">Group Tax</h1>
        <p class="text-sm text-gray-600">
          Manage Group Tax configurations and settings
        </p>
      </div>
...
export class GroupTaxComponent {
