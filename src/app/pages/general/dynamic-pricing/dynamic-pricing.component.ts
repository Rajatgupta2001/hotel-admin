...
@Component({
  ...
  template: `
    <div class="max-w-7xl mx-auto h-full">
      <div class="mb-4">
        <h1 class="text-xl font-bold text-gray-900 mb-1">Dynamic Pricing</h1>
        <p class="text-sm text-gray-600">
          Manage Dynamic Pricing configurations and settings
        </p>
      </div>
...
export class DynamicPricingComponent {
