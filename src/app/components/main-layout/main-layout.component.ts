...
@Component({
  ...
  styles: [
    `
      ...
      /* Material Design 3 List Item Customization */
      ::ng-deep .mat-mdc-list-item {
        --mdc-list-list-item-leading-icon-color: var(
          --md-sys-color-on-surface-variant
        );
        --mdc-list-list-item-label-text-color: var(--md-sys-color-on-surface);
        --mdc-list-list-item-leading-icon-size: 18px;
        --mdc-list-list-item-trailing-icon-size: 16px;
        font-size: 10px;
      }

      ::ng-deep .main-nav-item.active-link .mat-mdc-list-item-icon,
      ::ng-deep .main-nav-item.active-main-tab .mat-mdc-list-item-icon {
...
export class MainLayoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Initialize cross-navigation service to ensure localStorage is set up
    console.log('Cross-navigation data:', this.crossNavigationService.getStorageData());
  }
